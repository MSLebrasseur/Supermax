report 50016 "Standard Statement - SM"
{
    RDLCLayout = './Standard Statement - SM.rdl';
    WordLayout = './Standard Statement - SM.docx';
                    ...
                    dataitem(CustLedgEntryHdr; Integer)
                    {
                        ...
                        dataitem(DtldCustLedgEntries; "Detailed Cust. Ledg. Entry")
                        {
                            ...
                            begin
                                ...
                                //GES Start
                                IF CustLedgerEntry.GET(DtldCustLedgEntries."Cust. Ledger Entry No.") THEN
    ...
    begin
        ...
        Evaluate(StartDate, '1990-01-01');
        //Evaluate(EndDate,'2019-08-31');
        TodayDateTime := CREATEDATETIME(Today, 0T);
        EVALUATE(EndDate, FORMAT(Today));
        //GES End
    end;
