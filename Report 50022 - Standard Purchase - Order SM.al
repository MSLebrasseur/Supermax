report 50022 "Standard Purchase - Order SM"
{
    // GES - 20190822 - added fields:
    // TotQty, TotPaid, TotSubTotal, TotToPaid, TotTransport

    RDLCLayout = './Standard Purchase - Order SM.rdl';
    WordLayout = './Standard Purchase - Order SM.docx';
        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem("Purchase Line"; "Purchase Line")
            {
                ...
                begin
                    ...
                    //GES Start
                    IF (("Purchase Line".Type = Type::"G/L Account") AND ("Purchase Line"."No." = '5900')) THEN
                        TotTransport += "Purchase Line"."Line Amount"
                    ELSE BEGIN
                        TotQty += "Purchase Line".Quantity;
                        TotSubTotal += "Purchase Line"."Line Amount";
                        TotPaid += "Purchase Line"."Prepmt. Amt. Inv.";
                    END;
                    //GES End
    ...
    var
        ...
        VATAmountSpecificationLbl: Label 'Tax Amount Specification in ';
        ...
        VATDiscountAmountCaptionLbl: Label 'Payment Discount on Tax';
        ...
        PrepymtVATAmtSpecCaptionLbl: Label 'Prepayment Tax Amount Specification';
        AmountCaptionLbl: Label 'Amount';
        PurchLineInvDiscAmtCaptionLbl: Label 'Invoice Discount Amount';
        SubtotalCaptionLbl: Label 'Subtotal';
        VATAmtLineVATCaptionLbl: Label 'Tax %';
        ...
        VALVATBaseLCYCaptionLbl: Label 'Tax Base';
        PricesInclVATtxtLbl: Label 'Prices Including Tax';
        ...
        PricesIncludingVATCaptionLbl: Label 'Prices Including Tax';
